/**
 * @file main.js
 * @description Archivo principal que inicializa el Sistema Solar 3D, controles, animaciones y consola de navegación.
 */
...
// Nuevo módulo: Consola de navegación
...
// Consola de nave
const systemConsole = new Console();

// Escuchar comandos de navegación desde la consola
document.addEventListener('console-navigate', (e) => {
    const planetId = e.detail;
    
    // Actualizar botones activos
    document.querySelectorAll('.route-btn').forEach(btn => {
        btn.classList.toggle('active', btn.dataset.route === planetId);
    });
    
    // Navegar al planeta
    router.navigateTo(planetId);
});
