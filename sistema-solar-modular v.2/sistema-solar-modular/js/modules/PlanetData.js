/**
 * @class PlanetData
 * @description Almacena datos de planetas, configuración de rutas y texturas pre-cargadas.
 */
...
export class PlanetData {
    ...
    /**
     * Pre-cargar texturas para todos los planetas
     */
    static preloadTextures() {
        this.planets.forEach(planet => {
            planet.texture = Textures.createPlanetTexture(
                planet.color, 
                planet.size, 
                planet.texturePattern
            );
        });
    }
